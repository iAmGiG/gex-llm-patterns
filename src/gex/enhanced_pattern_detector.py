...
class EnhancedPatternDetector:
    ...
    def detect_gamma_trap_enhanced(self, gex_data: Dict, market_data: Dict, 
    ...
    def detect_all_patterns(self, gex_data: Dict, market_data: Dict, 
                          fed_context: Dict = None) -> List[Dict]:
...
def test_enhanced_pattern_detector():
    ...
    market_data = {
        'spot_price': 449.0  # Very close to flip point
    }
