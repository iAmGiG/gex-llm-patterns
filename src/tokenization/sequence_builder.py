...
class SequenceBuilder:
    ...
    def __init__(self, 
        ...
        Args:
            max_sequence_length: Maximum tokens per sequence (for LLM context limit)
            context_window_days: Default lookback period for sequences
        """
    ...
    def build_sequence(self, 
        ...
        Returnsionary with tokens and metadata
        """
    ...
    def build_pattern_sequences(self, 
        ...
        Args:
            ...
            pattern_length: Length of input pattern
            target_horizon: Days ahead to predict
            stride: Step size between sequences
        
        Returns of pattern sequences with targets
        """
        sequences = []
    ...
    def build_multi_timeframe_sequence(self, 
        ...
        Args:
            ...
            timeframes of lookback periods
    ...
    def _combine_tokens(self, 
        ...
        Args:
            tokensionary of token lists by type
    ...
    def validate_sequences(self, sequences) :
        ...
        Args:
            sequences of sequences to validate
