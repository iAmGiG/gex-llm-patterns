...
**Note**: This document complements the pattern library (`src/analysis/pattern_library.py`) by focusing on trading implementation. The pattern library contains the 15 core WHO/WHOM/WHAT patterns for LLM analysis, while this document provides practical trading rules and risk management.
