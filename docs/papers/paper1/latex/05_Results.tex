...
Table~\ref{tab:detection} reveals a 28.5 percentage point average gap between biased (100\%) and unbiased (71.5\%) detection rates. This quantifies the impact of leading information on detection sensitivity while validating that patterns remain detectable without hints.
