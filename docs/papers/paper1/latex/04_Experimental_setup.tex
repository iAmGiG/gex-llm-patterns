...
where $\Gamma_i$ is the gamma at strike $i$, $\text{OI}_i$ is open interest, the factor of 100 converts contracts to shares, and $S^2$ scales gamma to dollar exposure. Call gamma enters positively, while put gamma enters negatively. Negative net GEX indicates dealers are short gamma, requiring pro-cyclical hedging that amplifies price movements \cite{spotgamma2019,spotgamma2021,nomura2017}.
