...
def create_figure():
    ...
    # Main box
    before_box = FancyBboxPatch((0.5, 2.5), 4.5, 4,
                                boxstyle="round,pad=0.1",
                                edgecolor='darkred', facecolor=color_before,
                                linewidth=2.5, zorder=1)
    ax.add_patch(before_box)

    # Title
    ax.text(2.75, 7.3, 'BEFORE Obfuscation', ha='center', va='top',
            fontsize=12, fontweight='bold', color='darkred', zorder=10)
    ...
    for line in before_lines:
        ax.text(2.75, content_y, line, ha='center', va='top',
                fontsize=8, family='monospace', zorder=2)
        content_y -= 0.28

    # Bottom annotation
    ax.text(2.75, 1.8, 'Contains Temporal Context', ha='center', va='top',
            fontsize=9, style='italic', color='darkred', fontweight='bold', zorder=10)
    ax.text(2.75, 1.3, '(Enables training data memorization)', ha='center', va='top',
            fontsize=8, style='italic', color='darkred', zorder=10)

    # AFTER panel (right side)
    # Main box
    after_box = FancyBboxPatch((7, 2.5), 4.5, 4,
                               boxstyle="round,pad=0.1",
                               edgecolor='darkgreen', facecolor=color_after,
                               linewidth=2.5, zorder=1)
    ax.add_patch(after_box)

    # Title
    ax.text(9.25, 7.3, 'AFTER Obfuscation', ha='center', va='top',
            fontsize=12, fontweight='bold', color='darkgreen', zorder=10)
    ...
    for line in after_lines:
        ax.text(9.25, content_y, line, ha='center', va='top',
                fontsize=8, family='monospace', zorder=2)
        content_y -= 0.28

    # Bottom annotation
    ax.text(9.25, 1.8, 'Temporal Context Removed', ha='center', va='top',
            fontsize=9, style='italic', color='darkgreen', fontweight='bold', zorder=10)
    ax.text(9.25, 1.3, '(Forces reasoning from structure)', ha='center', va='top',
            fontsize=8, style='italic', color='darkgreen', zorder=10)
