...
\begin{enumerate}
    \item \textbf{Sensitivity vs. Guessing}: Non-detection days have 3.72$\times$ weaker GEX signal concentration (p < 0.0001, Cohen's d = 0.68). The LLM requires concentrated structural constraints, refuting base rate guessing.
