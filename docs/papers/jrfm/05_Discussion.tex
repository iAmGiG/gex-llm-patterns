...
\noindent\textbf{Threshold sensitivity}: All 29 tested parameter configurations maintained $>$68pp discrimination, but thresholds represent empirically validated design choices rather than first-principles derivations. Future work should explore adaptive thresholding based on market conditions.
