...
\subsection{Contributions to Finance and Data Science}

This work demonstrates how innovation in data science enables discovery in finance through four contributions:
...
This paper demonstrates how structural reasoning architectures can identify market microstructure evolution invisible to traditional econometric approaches. By extending temporal obfuscation protocols from single-day snapshots to 30-day windows across pre-0DTE (2020) and post-0DTE (2024) market eras, we establish that LLMs achieve high-fidelity discrimination of sustained market constraints that simple threshold rules miss. The 69.1 percentage point detection gap (12.1\% → 81.2\%) reveals 0DTE-driven regime persistence as a distinguishing characteristic of contemporary options markets, validated through comprehensive ablation studies and negative controls.

Our findings exemplify the interdisciplinary contribution that data science methods enable for finance research: a discovery about market structure change made possible by innovation in structural reasoning frameworks. This methodology advances beyond single-condition testing prevalent in prior work, establishing a rigorous validation protocol for deploying sequence analysis in market microstructure research.
