...
SpotGamma-inspired dark theme for publication-quality figures.
...
# =============================================================================
# DARK THEME COLORS (SpotGamma-inspired)
# =============================================================================
...
def style_axis(ax, title=None, xlabel=None, ylabel=None, grid=True):
    ...
    # Labels
    if title:
        ax.set_title(title, fontsize=FIGURE_DEFAULTS['font_title'],
                    fontweight='bold', color=DARK_THEME['text'], pad=10)
    if xlabel:
        ax.set_xlabel(xlabel, fontsize=FIGURE_DEFAULTS['font_label'],
                     fontweight='bold', color=DARK_THEME['text'])
    if ylabel:
        ax.set_ylabel(ylabel, fontsize=FIGURE_DEFAULTS['font_label'],
                     fontweight='bold', color=DARK_THEME['text'])
