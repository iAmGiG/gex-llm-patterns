...
def create_figure(results):
    ...
    bars = ax1.bar(years, detection_rates, color=colors, width=0.7,
                   edgecolor=DARK_THEME['background'], linewidth=1.5, alpha=0.9)
    ...
    ax1.annotate('', xy=(2024, 100), xytext=(2023, 20.2),
                 arrowprops=dict(arrowstyle='->', lw=3, color=DARK_THEME['accent_warning'],
                                linestyle='--'))
    ax1.text(2023.5, 60, '2023→2024\nStructural\nShift',
             ha='center', va='center', fontsize=11, fontweight='bold',
             color=DARK_THEME['text'],
             bbox=dict(boxstyle='round,pad=0.5', facecolor=DARK_THEME['panel_bg'],
                       edgecolor=DARK_THEME['accent_warning'], linewidth=2))
    ...
    ax2.plot(years, avg_gex, marker='o', markersize=10, linewidth=3,
             color=DARK_THEME['accent_warning'], markerfacecolor=DARK_THEME['accent_warning'],
    ...
    ax2.text(2020.3, 5.8, '$5B Threshold', fontsize=9, fontweight='bold',
             color=DARK_THEME['accent_positive'], va='bottom')
    ...
    ax2.set_title('Average GEX Magnitude Evolution (360% Growth 2021→2024)',
                  fontsize=12, fontweight='bold', pad=10, color=DARK_THEME['text'])
    ax2.set_ylim(0, 25)
