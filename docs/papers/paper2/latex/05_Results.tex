...
\begin{tabular}{lrrrl}
\toprule
\textbf{Year} & \textbf{Windows} & \textbf{Detection} & \textbf{Avg GEX} & \textbf{Era} \\
\midrule
2020 & 223 & 12.1\% & \$17.3B & Pre-transition \\
2021 & 250 & \textbf{100\%} & \$27.2B & \textbf{Structural shift} \\
2022 & 251 & 100\% & \$20.1B & Post-transition \\
2023 & 250 & 100\% & \$30.0B & Stable \\
2024 & 223 & 81.2\% & \$32.0B & Volatile \\
2025 & 221 & 100\% & \$30.4B & Mature \\
\midrule
\textbf{Total} & \textbf{1,418} & \textbf{73.8\%} & \textbf{\$26.0B} & -- \\
\bottomrule
\end{tabular}
\end{table}

\textbf{The 2020→2021 Transition}:
...
\textbf{Post-Transition Stability (2021-2023)}:
...
\textbf{2024 Volatility Correctly Identified}:

2024's 81.2\% detection (vs 100\% in 2021-2023) reflects genuine market instability:
\begin{itemize}
\item 42 non-detected windows had 6-10 sign flips (above ≤5 threshold)
...
\textbf{2025 Return to Stability}:
...
\textbf{Phase 4A (Multi-Year 2020-2025)}: 2020→2021 transition identified (12.1\% → 100\%), with sustained 100\% detection in 2021-2023 and 2025

\textbf{Conclusion}: The multi-year validation reveals 0DTE options caused a \textbf{permanent structural market shift in 2021}. Detection rates jumped from 12.1\% (2020 pre-0DTE) to 100\% (2021-2023 post-0DTE) and remained stable except during 2024's brief volatility (81.2\%). The framework correctly:
\begin{enumerate}
...
\textbf{2020 vs 2024 Comparison (Phase 4)}:
...
\textbf{2020→2021 Transition (Phase 4A)}:
...
\textbf{Post-2021 Consistency Test}:
