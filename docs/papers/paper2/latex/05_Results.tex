...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{../figures/output/figure8_validation_pipeline.png}
\caption{Multi-Phase Validation Pipeline. Detection rates progressed from Phase 1 baseline (71.2\%) through negative controls (6.3\%), full 2024 validation (81.2\%), 2020 pre-0DTE comparison (12.1\%), and complete multi-year expansion (73.8\% across 1,418 windows).}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{../figures/output/figure7_selectivity.png}
...
Phase 4A extended validation to all years 2020-2025 (1,418 total windows) to identify when the structural market shift occurred. Results revealed a sharp 2020→2021 transition, not gradual evolution (Figure~\ref{fig:temporal_trend}).
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{../figures/output/figure9_temporal_trend.png}
\caption{Detection Rate by Year: 0DTE Market Structure Transition. The 2020→2021 transition shows an 8.3x increase in detection rate (12.1\% to 100\%), with sustained 100\% detection in 2021-2023 and 2025. The 2024 dip (81.2\%) reflects transitional volatility correctly identified by the framework.}
