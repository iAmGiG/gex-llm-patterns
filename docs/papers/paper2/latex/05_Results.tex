...
\noindent\textbf{Methodology Note}: Phase 5 used PostgreSQL-migrated data with improved calendar coverage (filled Columbus Day, Veterans Day gaps), resulting in 241 windows for 2024 versus 223 windows in Phase 3's SQLite-based validation. The 100\% detection rate in Phase 5 reflects both complete data coverage and the structural dominance that emerged in late 2024. Phase 3's 81.2\% rate (181/223) remains valid for its November 2025 snapshot; Phase 5's higher rate reflects data completeness improvements from the January 2026 PostgreSQL migration.
...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{../figures/output/fig_gex_magnitude_distribution.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\textwidth]{figures/output/fig12_confidence_discrimination.png}
