...
We extended obfuscation-based LLM validation from single-day dealer gamma constraints to persistent 30-day market regimes, addressing a critical gap in temporal structural reasoning. Five-phase validation across 1,858 windows spanning six years (2020-2025) demonstrates that LLMs can identify sustained dealer positioning through three structural criteria: persistence ($\geq$70\% same-sign dominance), magnitude ($\geq$\$5B average), and stability ($\leq$5 sign flips), while tracking gradual market structure evolution through 0DTE adoption.
...
\textbf{Gradual 0DTE adoption pattern identified}: Phase 4A multi-year validation (1,412 windows, 2020-2025) revealed that the structural shift occurred through gradual adoption culminating in a 2023→2024 transition, not a sharp 2020→2021 change. Detection rates tracked market evolution precisely: 2020 (12.2\%), 2021 (3.7\%), 2022 (32.4\%), 2023 (20.2\%), 2024 (100\%), 2025 (100\%). This gradual pattern strengthens causal attribution—detection tracks 0DTE market penetration rather than exhibiting binary behavior.

\textbf{Magnitude-driven regime shift}: GEX magnitude grew 360\% from \$5B (2021) to \$23B (2024), far exceeding 20-25\% cumulative inflation. The fixed \$5B threshold effectively discriminated borderline markets (2021: 3.7\% detection) from structural regimes (2024: 100\% detection), validating threshold design. The 4.95× detection increase (20.2\% → 100\%) temporally coincides with 0DTE trading explosion in late 2023.
...
\item \textbf{Cost-effective comprehensive testing}: OpenAI Batch API enabled five-phase validation at \$11.67 total cost (50\% savings vs synchronous API), making rigorous multi-year testing economically feasible for academic research
\end{enumerate}
