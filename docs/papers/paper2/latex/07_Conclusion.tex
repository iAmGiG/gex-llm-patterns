...
\textbf{Multi-year transition analysis}: Testing 2021, 2022, 2023, and 2025 will isolate the 0DTE transition period. If regime persistence increased sharply in 2022 (when daily SPY expirations launched) rather than gradually 2020-2024, this would strengthen causal attribution to 0DTE proliferation beyond current temporal coincidence evidence.

\textbf{Cross-asset generalization} (Paper \#3): Extending to individual equities (AAPL, MSFT, NVDA, TSLA) will test whether regime detection generalizes beyond S\&P 500 index options and identify asset-specific vs market-wide regime characteristics.
