...
Large language models (LLMs) have demonstrated remarkable capabilities in natural language understanding and reasoning tasks, yet their ability to detect structural constraints in financial markets remains underexplored. While our companion paper (Paper \#1) established that LLMs can identify single-day dealer gamma constraints through obfuscation testing~\cite{regan2025obfuscation}, these snapshots capture only instantaneous market structure. Real dealer positioning evolves over multi-day horizons, creating \textit{persistent regimes} characterized by sustained structural constraints lasting weeks or months.
