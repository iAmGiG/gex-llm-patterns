...
\noindent\textbf{Market structure modernization}: Growth in quantitative trading, increased options liquidity, and algorithmic market making may have independently increased positioning persistence. Disentangling these effects requires testing intermediate years (2021-2023) to identify transition timing.

\vspace{0.2cm}

\noindent\textbf{Multi-year validation confirms sharp transition}: Testing across 2021-2023 and 2025 (972 additional windows) isolated the 0DTE transition period. Regime persistence increased \textit{sharply} in 2021 (12.1\% $\rightarrow$ 100\% detection), not gradually across 2020-2024. This sharp transition—occurring simultaneously with 0DTE emergence and sustained through 2021-2023 equilibrium—strengthens causal attribution to 0DTE proliferation beyond temporal coincidence. The 2024 anomaly (81.2\% detection) represents transitional volatility, not regime collapse, as 2025 returned to 100\% detection.
