...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{../figures/output/fig08_detection_progression.png}
...
\noindent\textbf{Reconciling with intraday literature}: Previous studies~\cite{dim2025zero} document positive market maker gamma during trading hours. Our persistent negative regime findings are consistent with this: we measure the residual inventory \textit{after} the daily unwind. The sign flip from intraday-positive to EOD-negative likely reflects the structural ``scar tissue'' of dealers closing liquid long gamma positions while being forced to carry illiquid short gamma inventory overnight.

\vspace{0.3cm}

\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{../figures/output/fig09_scar_tissue.png}
...
\begin{figure*}[ht]
\centering
\includegraphics[width=\textwidth]{../figures/output/fig10_borderline_persistence.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{../figures/output/fig11_threshold_sensitivity.png}
...
\textbf{Exclusive focus on gamma}: While we isolate gamma exposure as the primary driver of short-dated hedging, we acknowledge that vega and vanna flows dominate longer-tenor positioning. However, given that 0DTE options have negligible vega sensitivity due to imminent expiry, gamma remains the relevant realized volatility sensitivity for this specific market structure.

\textbf{Aggregation across market makers}: Our OI-based GEX metric aggregates positioning across all market maker types (firm, broker-dealer, customer). While proprietary datasets could disaggregate these flows, the net aggregate positioning remains the relevant signal for determining system-wide hedging constraints.
