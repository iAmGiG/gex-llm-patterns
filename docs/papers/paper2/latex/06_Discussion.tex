...
\noindent\textbf{Four-phase validation confirms 2020 vs 2024 structural difference}: Phase 4 tested 223 windows from 2020 using identical methodology to 2024, revealing a 69.1 percentage point detection difference (12.1\% vs 81.2\%). This large effect size ($\phi$ = 0.672) provides quantitative evidence of fundamental market structure change between pre-0DTE and post-0DTE eras. While 0DTE options proliferated gradually (2020 $<$5\% volume → 2024 43\% volume), the magnitude of the detection difference suggests substantial structural reorganization of dealer positioning.
...
\noindent\textbf{Implications for regime theory}: The 69.1 percentage point difference suggests regime persistence—previously an exceptional market state in 2020—became substantially more common in post-0DTE markets. Future work extending validation to intermediate years (2021-2023) may identify the precise timing of structural transition.
...
\textbf{Limited temporal scope}: Our validation covers only 2020 and 2024, representing pre-0DTE and post-0DTE eras respectively. Future work should extend to intermediate years (2021-2023) to identify the precise timing of structural transition, and to longer-term historical periods (2008-2010 financial crisis, 2016-2018 VIX ETF proliferation) to contextualize whether similar regime transitions occurred during earlier options market innovations.
...
Despite these limitations, four-phase validation across 446 windows (2020 and 2024) with comprehensive negative controls establishes that LLMs can identify persistent dealer gamma regimes through structural reasoning. The 69.1 percentage point detection difference between pre-0DTE (2020: 12.1\%) and post-0DTE (2024: 81.2\%) eras provides strong evidence of market structure change, extending obfuscation testing methodology to multi-day temporal domains.
