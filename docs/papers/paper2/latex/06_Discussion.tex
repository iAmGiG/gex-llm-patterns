...
\textbf{Two years only (2020, 2024)}: While 69.1 pp difference is statistically significant (p $<$ 0.0001), comprehensive multi-year testing (2020-2025) would strengthen causal attribution to 0DTE proliferation by identifying precise transition timing. If regime persistence increased sharply in 2022 (when daily SPY expirations launched) rather than gradually across 2020-2024, this would provide stronger evidence for 0DTE causation beyond temporal coincidence. Additionally, 15-year historical analysis of options market activity and GEX dynamics could reveal longer-term structural trends, including potential correlations with credit expansion and evolving market microstructure.
