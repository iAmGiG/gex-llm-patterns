...
\noindent\textbf{Results}: Price normalization applied a 2.3× multiplier to 2020 GEX magnitudes (reflecting 52\% SPY appreciation, 330 → 500). This adjustment increased 2020 detection from the unadjusted 12.1\% to approximately 35.6\% (+23.5 percentage points), accounting for \textbf{34\%} of the total 69.1 pp gap between 2020 and 2024. The remaining 45.6 pp (\textbf{66\%}) persists after normalization, attributable to structural evolution in dealer positioning (persistence, stability, sustained directional bias).
