...
\textbf{Framework-dependent reasoning}: Future ablation studies will investigate whether LLMs need the WHO→WHOM→WHAT causal framework or can detect constraints from data alone. This will clarify the role of prompt structure in enabling structural reasoning.
