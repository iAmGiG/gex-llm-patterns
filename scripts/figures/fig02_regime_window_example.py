...
def create_figure(example_data, output_path):
    ...
    # Plot bars
    days = np.arange(1, 31)
    bars = ax.bar(days, gex_values, color=colors, width=0.8,
                  edgecolor=DARK_THEME['background'], linewidth=0.5, alpha=0.9)
    ...
    ax.text(0.98, 0.98, stats_text, transform=ax.transAxes, fontsize=10,
            ...
            bbox=dict(boxstyle='round,pad=0.5', facecolor=DARK_THEME['panel_bg'],
                      edgecolor=DARK_THEME['accent_negative'], linewidth=2, alpha=0.95),
            family='monospace')
    ...
    ax.set_title('30-Day Persistent Negative Regime Example\n'
