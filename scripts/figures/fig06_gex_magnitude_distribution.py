...
def create_magnitude_histogram(data, output_path):
    ...
    ax.hist(mag_2020, bins=bins, alpha=0.7, label=f'2020 Pre-0DTE (n={len(mag_2020)})',
            color=DARK_THEME['year_2020'], edgecolor=DARK_THEME['background'], linewidth=0.8)
    ax.hist(mag_2024, bins=bins, alpha=0.7, label=f'2024 Post-0DTE (n={len(mag_2024)})',
            color=DARK_THEME['year_2024'], edgecolor=DARK_THEME['background'], linewidth=0.8)

    # Add $5B threshold line with neon green
    ax.axvline(x=5.0, color=DARK_THEME['accent_positive'], linestyle='--', linewidth=2.5,
               label='$5B Regime Threshold', zorder=10)
    ...
    ax.annotate(f'2020 Mean\n${mean_2020:.1f}B',
                ...
                fontsize=11, fontweight='bold', color=DARK_THEME['year_2020'],
    ...
    ax.annotate(f'2024 Mean\n${mean_2024:.1f}B',
                ...
                fontsize=11, fontweight='bold', color=DARK_THEME['year_2024'],
    ...
    ax.annotate('Regime\nThreshold',
                ...
                fontsize=10, fontweight='bold', color=DARK_THEME['accent_positive'],
    ...
    ax.text(0.98, 0.97, stats_text, transform=ax.transAxes, fontsize=10,
            ...
            bbox=dict(boxstyle='round,pad=0.5', facecolor=DARK_THEME['background'],
                      edgecolor=DARK_THEME['dim'], alpha=0.95),
            family='monospace', color=DARK_THEME['text'])
