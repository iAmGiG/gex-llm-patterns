...
def create_figure_3():
    ...
    ax.annotate('', xy=(1, 92.3), xytext=(0, 61.5),
                arrowprops=dict(arrowstyle='->', color='#059669', lw=2.5,
                                connectionstyle='arc3,rad=0.2'))
    ax.text(0.5, 78, '+30.8 pp', ha='center', fontsize=14,
    ...
    ax.set_title('Raw Chain Validation: LLM Outperforms GEX-Assisted Baseline\n'
    ...
    props = dict(boxstyle='round', facecolor='#f0fdf4', alpha=0.95,
                 edgecolor='#059669', linewidth=1.5)
    ...
    # PNG
    png_path = OUTPUT_DIR / 'fig3_raw_chain.png'
    plt.savefig(png_path, dpi=300, bbox_inches='tight', facecolor='white')
    print(f"Saved: {png_path}")

    # PDF for LaTeX
    pdf_path = OUTPUT_DIR / 'fig3_raw_chain.pdf'
