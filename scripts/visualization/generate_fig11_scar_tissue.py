#!/usr/bin/env python3
"""
Generate Figure 11: Scar Tissue Mechanism Diagram
...
fig, ax = plt.subplots(1, 1, figsize=(14, 9), dpi=120)
ax.set_xlim(0, 10)
ax.set_ylim(0, 10)
ax.axis('off')

# Color scheme: professional, publication-ready
color_intraday = '#2E86AB'      # Deep blue for intraday
color_volatility = '#A23B72'    # Purple for volatility
color_positioning = '#F18F01'   # Orange for positioning
color_measurement = '#C73E1D'   # Deep red for measurement
color_mechanism = '#6A994E'     # Green for mechanism
color_arrow = '#555555'         # Dark gray for arrows
...
ax.text(5, 9.0, subtitle, fontsize=12, style='italic',
        ha='center', va='top', family='sans-serif', color='#555555')
...
box1 = FancyBboxPatch((box1_x, box1_y), box_width, box_height,
                      ...
                      facecolor=color_intraday, edgecolor='black', linewidth=2, alpha=0.85)
ax.add_patch(box1)
...
box2 = FancyBboxPatch((box2_x, box2_y), box_width, box_height,
                      boxstyle="round,pad=0.1",
                      facecolor=color_mechanism, edgecolor='black', linewidth=2, alpha=0.85)
ax.add_patch(box2)
...
box3 = FancyBboxPatch((box3_x, box3_y), box_width, box_height,
                      boxstyle="round,pad=0.1",
                      facecolor=color_volatility, edgecolor='black', linewidth=2, alpha=0.85)
ax.add_patch(box3)
...
box5 = FancyBboxPatch((box5_x, box5_y), box_width, box_height,
                      boxstyle="round,pad=0.1",
                      facecolor='#CCCCCC', edgecolor='black', linewidth=2, alpha=0.85)
ax.add_patch(box5)
...
ax.annotate('', xy=(box5_x, box4_y + box_height/2),
            ...
            arrowprops=dict(arrowstyle='->', lw=2.5, color=color_arrow, linestyle='dashed'))

# Box 6: Incomplete Position Unwinding
box6_x, box6_y = 6.5, y_start - 1.3
box6 = FancyBboxPatch((box6_x, box6_y), box_width, box_height,
                      boxstyle="round,pad=0.1",
                      facecolor=color_positioning, edgecolor='black', linewidth=2, alpha=0.85)
ax.add_patch(box6)
...
box8 = FancyBboxPatch((box8_x, box8_y), box_width, box_height,
                      boxstyle="round,pad=0.1",
                      facecolor=color_measurement, edgecolor='black', linewidth=2.5, alpha=0.9)
ax.add_patch(box8)
...
scar_box = FancyBboxPatch((scar_box_x, scar_box_y), scar_width, scar_height,
                          boxstyle="round,pad=0.1",
                          facecolor='#FFF9E6', edgecolor='#FF6B00', linewidth=2.5, linestyle='--')
...
ax.text(0.3, 6.2, "INTRADAY\nMECHANISM", fontsize=9, fontweight='bold',
        ha='center', va='center', color=color_intraday, rotation=90, family='sans-serif')

# Right side: What we measure
ax.text(9.2, 6.0, "MEASUREMENT\nLAYER", fontsize=9, fontweight='bold',
        ha='center', va='center', color=color_measurement, rotation=90, family='sans-serif')
...
insight_y = 0.3
insights = [
    ("1. Daily Cycle", "0DTE options expire\nand roll daily", color_intraday),
]
...
ax.text(5, -0.8, footer_text, fontsize=9, ha='center', va='top',
        family='sans-serif', color='#555555', wrap=True, style='italic')

plt.tight_layout()
plt.savefig('/mnt/bst/a100/yxie2/cregan1/gex-llm-patterns-issue168/docs/papers/paper2/figures/output/fig11_scar_tissue.png',
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
print("✅ Figure 11 saved: docs/papers/paper2/figures/output/fig11_scar_tissue.png")

# Also save at 150 DPI for web/presentation
plt.savefig('/mnt/bst/a100/yxie2/cregan1/gex-llm-patterns-issue168/docs/papers/paper2/figures/output/fig11_scar_tissue_web.png',
            dpi=150, bbox_inches='tight', facecolor='white', edgecolor='none')
print("✅ Web version saved: docs/papers/paper2/figures/output/fig11_scar_tissue_web.png")
